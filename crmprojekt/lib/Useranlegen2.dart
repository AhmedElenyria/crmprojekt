...
class Useranlegen2 extends StatefulWidget {
  @override
  _MyFormPageState createState() => _MyFormPageState();
}


class _MyFormPageState extends State<Useranlegen2> {
  TextEditingController nameC = TextEditingController();
  TextEditingController emailC = TextEditingController();
  TextEditingController adminC = TextEditingController(text: "admin2");
...
void initState() {
    ...
    //Generiere ein zufälliges Passwort beim Initialisieren des Widgets
    String initialPassword = generatePassword(8);
    
    //Initialisiere den Controller mit dem generierten Passwort
...
String? validateField(String? value, String fieldName) {
  ...
  //Zusätzliche Validierung für das E-Mail-Feld
        ...
        actions: <Widget>[
          TextButton(
            onPressed: () {
              ...
              //Navigator.push(context, MaterialPageRoute(builder: (context) => Useranlegen2()));
               Navigator.pushReplacementNamed(context, '/Useranlegen2');
            },
            child: Text('OK'),
          ),
        ],
...
void _submitForm() async {
  setState(() {
    // Setzen Sie _autovalidateMode auf always, um die Validierung auszulösen
  ...
  if (_formKey.currentState!.validate()) {
    ...
    if (userCreated) {
      ...
      setState(() {
        ...
        showSuccessDialog(context); // Zurücksetzen _autovalidateMode
      });
    } else {
      // Erstellung des Benutzers fehlgeschlagen (e.g Benutzer existiert bereits)
