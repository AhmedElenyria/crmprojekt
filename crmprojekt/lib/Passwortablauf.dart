...
class Passwortablauf extends StatefulWidget {
  @override
  _PasswordConfirmationPageState createState() => _PasswordConfirmationPageState();
}

class _PasswordConfirmationPageState extends State<Passwortablauf> {
 // String loggedInUsername = '';
  ...
  Widget build(BuildContext context) {
    final hinweis = 'Ihr Passwort ist abgelaufen. Bitte wählen Sie ein neues Passwort aus, um fortzufahren.';
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: Colors.red, // oder eine andere Farbe Ihrer Wahl
              ),
            ),
            TextField(
